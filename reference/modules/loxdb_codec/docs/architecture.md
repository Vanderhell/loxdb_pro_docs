...
`loxdb_codec` is organized as a small set of focused C modules:

- `include/loxdb_codec.h`: public API, compile-time configuration, shared types
...
- `src/loxdb_codec.c`: dispatch API
